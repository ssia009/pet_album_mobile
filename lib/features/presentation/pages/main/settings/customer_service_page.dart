...
class CustomerServicePage extends StatelessWidget {
  ...
  static const List<Map<String, String>> _faqs = [
    ...
    {
      'q': '로그인이 되지 않아요.',
      'a': '이메일 또는 비밀번호가 올바르게 입력되었는지 확인해 주세요. 문제가 계속되면 비밀번호 재설정을 이용해 주세요.',
    },
    {
      'q': '비밀번호를 잊어버렸어요.',
      'a': '로그인 화면의 비밀번호 찾기를 눌러 이메일 인증 후 새 비밀번호를 설정할 수 있어요.',
    },
    {
      'q': '이메일을 변경할 수 있나요?',
      'a': '이메일 변경이 필요한 경우 문의하기를 통해 고객센터로 연락해 주세요.',
    },
    {
      'q': '아이디/비밀번호 변경',
      'a': '설정 또는 마이페이지에서 회원 탈퇴 메뉴를 통해 탈퇴할 수 있어요.',
    },
    {
      'q': '앱 이용 중 오류가 발생했어요.',
      'a': '앱을 최신 버전으로 업데이트하거나 앱을 다시 실행해 주세요. 문제가 계속되면 문의하기를 통해 알려주세요.',
    },
    {
      'q': '알림이 오지 않아요.',
    ...
    {
      'q': '개인정보는 안전하게 보호되나요?',
      'a': '서비스는 개인정보 보호정책에 따라 사용자의 정보를 안전하게 관리하고 보호하고 있어요.',
    },
    {
      'q': '문의는 어떻게 할 수 있나요?',
      'a': '문의하기 메뉴를 통해 이메일로 문의를 보내주시면 확인 후 답변드려요.',
    },
  ];
